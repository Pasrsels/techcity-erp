...
class ZIMRA:
    ...
    def open_day(self):
        ...
        try:
            ...
            logger.success(f'Fiscal day {next_day_no} opened successfully')
            return {"success": True, "message": f"Fiscal day {next_day_no} opened successfully"}
        except Exception as e:
            logger.error(f"Error opening fiscal day: {e}")
            return {"success": False, "message": f"Error opening fiscal day: {e}"}
