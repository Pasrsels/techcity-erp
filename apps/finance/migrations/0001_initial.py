    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('discount_amount', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, null=True)),
                ('delivery_charge', models.DecimalField(decimal_places=2, default=0.0, max_digits=10, null=True)),
                ...
                ('payment_terms', models.CharField(choices=[('cash', 'cash'), ('layby', 'layby'), ('installment', 'installment')])),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('date', models.DateField(auto_now_add=True)),
                ('invoice', models.OneToOneField(null=True, on_delete=django.db.models.deletion.CASCADE, to='finance.invoice')),
            ],
        ),
    ]
