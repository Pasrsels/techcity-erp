...
class FiscalCounter(models.Model):
    ...
    fiscal_day = models.ForeignKey(FiscalDay, on_delete=models.CASCADE, related_name='counters', null=True, blank=True)
    ...
    fiscal_counter_tax_percent = models.DecimalField(max_digits=5, decimal_places=2, default=0.00, null=True, blank=True)
