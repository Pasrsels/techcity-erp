    ...
    <body class="{% block bodyclass %}{% endblock %}">
      <div class="wrapper">
          ...
          <div id="content">
            ...
            {% if post_form %}
              <button type="button" class="button-form btn btn-outline-dark" data-toggle="modal" data-target="#createModal">
                <span class="glyphicon glyphicon-plus" aria-hidden="true"></span> Create
              </button>
            {% endif %}

            {% if put_form %}
              <button type="button" class="button-form btn btn-outline-dark" data-toggle="modal" data-target="#editModal">
